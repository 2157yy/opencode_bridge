...
export class OpenCodeBridge {
    ...
    async pollOnce() {
        ...
        for (const agent of this.registry.list()) {
            const sessionStatus = statuses[agent.sessionId];
    ...
    async handleProcessError(agentId, error) {
